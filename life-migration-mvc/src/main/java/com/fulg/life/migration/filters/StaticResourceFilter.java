package com.fulg.life.migration.filters;
...
/**
 * Filter which allows us to bypass all of the spring filters for requests to a given path. This is a simple servlet
 * filter. It is intended to be used to serve static resources from the web application. I can be used early in the
 * filter chain to bypass any spring setup or hybris session setup for the static resources.
 */
